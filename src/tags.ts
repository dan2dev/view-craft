import { createElementBuilder } from "./element-builder";
...
export const selfClosingTags: (keyof HTMLElementTagNameMap)[] = [
 ...
 */
export function registerGlobalTags(): void {
  htmlTags.forEach((tag: ElementTagName) => {
    // @ts-ignore
    globalThis[tag] = createElementBuilder(tag);
  });
}