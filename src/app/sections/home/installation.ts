...
export function installationSection() {
  return section(
    ...
    p({ className: 'text-base text-slate-300' }, 'One import to rule them all. Seriously, just one line and you get 140+ global functions. It\'s like Christmas morning for your code editor.'),
