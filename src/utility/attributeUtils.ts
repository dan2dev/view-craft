 ...
 */
export function applyStyleProperties(element: ExpandedElement<any>, styleObj: StyleObject): void {
 ...
 */
export function createUpdateHandler<TTagName extends ElementTagName>(
  element: ExpandedElement<TTagName>,
  key: keyof ExpandedElementAttributes<TTagName>,
